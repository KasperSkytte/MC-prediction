...
ggsave(
  file.path(results_batch_dir, "boxplot_all_BC.pdf"),
  plot = bp_all_BC,
  width = 180,
  height = 185,
  units = "mm",
...
ggsave(
  file.path(results_batch_dir, "boxplot_all.pdf"),
  plot = bp_all_plot,
  width = 180,
  height = 210,
  units = "mm",
...
ggsave(
  "results/predwindow_mariagerfjord/boxplot_all_BC.pdf",
...
ggsave(
  ...
  filename = file.path(
    results_dir,
    "..",
    paste0("realvspredictedheatmap_", basename(results_dir), ".pdf")
  ),
  width = 450,
  height = 300,
  units = "mm",
...
ggsave(
  ...
  filename = file.path(
    graph_matrix_dir,
    "..",
    "graph_network_plot_mariagerfjord.pdf"
  ),
  width = 88,
  height = 88,
  units = "mm",
