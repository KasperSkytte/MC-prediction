...
ggsave(
  file.path(results_batch_dir, "Figure 2.pdf"),
  plot = bp_all_BC,
  width = 180,
  height = 185,
  units = "mm",
...
fwrite(
  out,
  file.path(results_batch_dir, "Figure 2.csv")
)
```
...
ggsave(
  file.path(results_batch_dir, "boxplot_all_BC_graph.pdf"),
...
ggsave(
  file.path(results_batch_dir, "Figure S4.png"),
  plot = bp_all_plot,
  width = 300,
  height = 300,
  units = "mm",
...
fwrite(
  bp_all_plot$data,
  file.path(results_batch_dir, "Figure S4.csv")
)
```
...
fwrite(
  plot$data,
  file.path("results/nsamplestest", "Figure S5.csv")
)
```
...
# All WWTPs test data (real+pred) combined (Figure S6)
```{r}
wwtp_results_dirs <- list.dirs(
  results_batch_dir,
  full.names = TRUE,
...
# write out plot data
fwrite(
  plot_genus_func$data,
  file.path(results_batch_dir, "Figure S6.csv")
)
