...
genus64 <- long[grepl("^genus64;", OTU)]
genus64_ts <- plot_timeseries(genus64, save = FALSE) +
  ggtitle("genus64; s__; g__Parabacteroides") +
  theme(
    legend.position = "none",
    axis.text.x = element_blank(),
    axis.ticks.x = element_blank(),
...
genus64_obs_pred <- plot_obs_pred(genus64)

genus69 <- long[grepl("^genus69;", OTU)]
genus69_ts <- plot_timeseries(genus69, save = FALSE) +
  ggtitle("genus69; s__; g__") +
  theme(
    legend.position = "none",
    axis.text.x = element_blank(),
    axis.ticks.x = element_blank()
  )
genus69_obs_pred <- plot_obs_pred(genus69)

genus122 <- long[grepl("^genus122;", OTU)]
genus122_ts <- plot_timeseries(genus122, save = FALSE) + 
  ggtitle("genus122; s__; g__Clostridium") +
  theme(
    legend.position = "bottom",
    legend.text = element_text(size = 12),
    axis.title.y = element_blank()
  )
genus122_obs_pred <- plot_obs_pred(genus122)

# "g__Romboutsia"
# "g__Tetrasphaera"

plot <- genus64_ts + genus64_obs_pred +
  genus69_ts + genus69_obs_pred +
  genus122_ts + genus122_obs_pred +
  plot_layout(
    ncol = 2,
    nrow = 3,
    heights = 4,
