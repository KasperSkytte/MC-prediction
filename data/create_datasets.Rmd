...
ggsave(
  "samples_overview_all.png",
  plot = samples_overview_all
)
```

# overview of samples over time (only those selected for the paper, Figure S2)
...
ggsave(
  "Figure S2.pdf",
  plot = samples_overview
)

# write out plot data
fwrite(
  samples_overview$data,
  "Figure S2.csv"
)
```

# Overview of sampling intervals (Figure S1)
...
ggsave(
  "Figure S1.pdf",
  plot = sampling_intervals
)

# write out plot data
fwrite(
  sampling_intervals$data,
  "Figure S1.csv"
)
```
